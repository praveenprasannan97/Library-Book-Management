...
(1, 'contenttypes', '0001_initial', '2024-10-05 11:00:38.881168'),
(2, 'auth', '0001_initial', '2024-10-05 11:00:39.156828'),
(3, 'admin', '0001_initial', '2024-10-05 11:00:39.239781'),
(4, 'admin', '0002_logentry_remove_auto_add', '2024-10-05 11:00:39.245803'),
(5, 'admin', '0003_logentry_add_action_flag_choices', '2024-10-05 11:00:39.251781'),
(6, 'contenttypes', '0002_remove_content_type_name', '2024-10-05 11:00:39.287870'),
(7, 'auth', '0002_alter_permission_name_max_length', '2024-10-05 11:00:39.319916'),
(8, 'auth', '0003_alter_user_email_max_length', '2024-10-05 11:00:39.330560'),
(9, 'auth', '0004_alter_user_username_opts', '2024-10-05 11:00:39.332412'),
(10, 'auth', '0005_alter_user_last_login_null', '2024-10-05 11:00:39.365437'),
(11, 'auth', '0006_require_contenttypes_0002', '2024-10-05 11:00:39.367977'),
(12, 'auth', '0007_alter_validators_add_error_messages', '2024-10-05 11:00:39.372407'),
(13, 'auth', '0008_alter_user_username_max_length', '2024-10-05 11:00:39.381708'),
(14, 'auth', '0009_alter_user_last_name_max_length', '2024-10-05 11:00:39.383357'),
(15, 'auth', '0010_alter_group_name_max_length', '2024-10-05 11:00:39.400690'),
(16, 'auth', '0011_update_proxy_permissions', '2024-10-05 11:00:39.406024'),
(17, 'auth', '0012_alter_user_first_name_max_length', '2024-10-05 11:00:39.409756'),
(18, 'authtoken', '0001_initial', '2024-10-05 11:00:39.465305'),
(19, 'authtoken', '0002_auto_20160226_1747', '2024-10-05 11:00:39.482898'),
...
--
-- Table structure for table `userapi_author`
--

CREATE TABLE `userapi_author` (
  `id` bigint(20) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `userapi_author`
--
...
--
-- Table structure for table `userapi_book`
--

CREATE TABLE `userapi_book` (
  `id` bigint(20) NOT NULL,
  `title` varchar(255) NOT NULL,
  `ISBN` varchar(13) NOT NULL,
  `publication_date` date NOT NULL,
  `copies_available` int(10) UNSIGNED NOT NULL CHECK (`copies_available` >= 0),
...
--
-- Table structure for table `userapi_book_authors`
--

CREATE TABLE `userapi_book_authors` (
  `id` bigint(20) NOT NULL,
...
--
-- Table structure for table `userapi_borrowinghistory`
--

CREATE TABLE `userapi_borrowinghistory` (
  `id` bigint(20) NOT NULL,
...
--
-- Indexes for table `userapi_author`
--
ALTER TABLE `userapi_author`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `userapi_book`
--
...
--
-- Indexes for table `userapi_book_authors`
--
ALTER TABLE `userapi_book_authors`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `userapi_book_authors_book_id_author_id_23f1fe62_uniq` (`book_id`,`author_id`),
  ADD KEY `userapi_book_authors_author_id_a46ba636_fk_userapi_author_id` (`author_id`);

--
-- Indexes for table `userapi_borrowinghistory`
--
ALTER TABLE `userapi_borrowinghistory`
  ADD PRIMARY KEY (`id`),
  ADD KEY `userapi_borrowinghistory_book_id_52b5e133_fk_userapi_book_id` (`book_id`),
  ADD KEY `userapi_borrowinghistory_user_id_3e557908_fk_auth_user_id` (`user_id`);
